...
from desktop.theme.scaling import control_px, font_px, layout_px
...
ANALYTICS_ROOT_MARGIN = layout_px(14)
ANALYTICS_ROOT_SPACING = layout_px(14)
ANALYTICS_SUMMARY_SPACING = layout_px(10)
ANALYTICS_INSIGHT_LINE_SPACING = layout_px(4)
ANALYTICS_COMPLETENESS_SPACING = layout_px(4)
ANALYTICS_COMPLETENESS_BOTTOM_SPACING = layout_px(8)
ANALYTICS_SECTION_PADDING = layout_px(16)
ANALYTICS_SECTION_SPACING = layout_px(10)
ANALYTICS_SUMMARY_CARD_PADDING = layout_px(12)
ANALYTICS_SUMMARY_CARD_SPACING = layout_px(2)
ANALYTICS_DENSE_ROW_PADDING_X = layout_px(8)
ANALYTICS_DENSE_ROW_PADDING_Y = layout_px(6)
ANALYTICS_DENSE_ROW_SPACING = layout_px(12)
ANALYTICS_DENSE_TEXT_SPACING = layout_px(2)
...
SUMMARY_CARD_HEIGHT = layout_px(88)
SUMMARY_ICON_BADGE_SIZE = layout_px(36)
SECTION_HEADER_ICON_BADGE_SIZE = layout_px(28)
...
DENSE_SCORE_BADGE_SIZE = layout_px(56)

BAR_TRACK_WIDTH = control_px(330)
BAR_HEIGHT = control_px(12)
