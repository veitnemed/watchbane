...
LIST_ITEM_HEIGHT = list_px(72)
LIST_THUMB_WIDTH = list_px(40)
LIST_THUMB_HEIGHT = list_px(60)
LIST_ITEM_H_PADDING = list_px(10)
LIST_ITEM_V_PADDING = list_px(6)
LIST_TEXT_GAP = list_px(10)
GENRES_PER_ROW = 4
