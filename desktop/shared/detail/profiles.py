...
CANDIDATE_DETAIL_CARD_PROFILE = replace(
    ...
    include_bottom_stretch=False,
    detail_content_max_width=detail_px(720),
    detail_poster_width=poster_px(260),
    detail_poster_height=poster_px(382),
    detail_poster_right_gap=detail_px(24),
    detail_info_min_width=detail_px(300),
    detail_info_column_max_width=detail_px(380),
    detail_section_max_width=detail_px(380),
    detail_rating_widget_size=detail_px(96),
    detail_rating_circle_diameter=detail_px(84),
    detail_stars_left_gap=detail_px(18),
    detail_star_size=detail_px(28),
    detail_star_gap=detail_px(6),
    detail_main_info_label_width=detail_px(150),
    detail_main_info_panel_padding_x=detail_px(18),
)
