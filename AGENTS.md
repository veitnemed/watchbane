...
Watchbane — локальная **колода «что посмотреть дальше»** (фильм/сериал): до **10** карточек с постерами, действия **смотрел / сохранить / скрыть**. Не каталог, не стриминг, не like/dislike.
...
| Новая фича / вектор A / B / web / like-dislike / LLM | **Отклонить** + риски + куда в backlog |
