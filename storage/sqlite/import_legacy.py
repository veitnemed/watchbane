"""Import legacy JSON runtime data into SQLite."""
...
def import_legacy_json_to_sqlite(
    *,
    ...
    payloads = {
        "watched": _load_mapping(paths.titles),
        "meta": _load_mapping(paths.meta),
        "candidate_pool": _load_mapping(paths.candidate_pool),
        "candidate_criteria": _load_mapping(paths.candidate_criteria),
        "watchlist": _load_mapping(paths.watchlist),
        "hidden": _load_mapping(paths.hidden),
        "settings": _load_mapping(paths.settings),
        "poster_cache": _load_mapping(paths.poster_cache),
    }
    report = {
        "ok": True,
        "dry_run": dry_run,
