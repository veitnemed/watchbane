...
a = Analysis(
    ...
    datas=[
        ...
        ("scripts/tmdb-network-diagnose.ps1", "scripts"),
        ("scripts/tmdb-network-compare.ps1", "scripts"),
        ("scripts/tmdb-dns-recovery.ps1", "scripts"),
        ("scripts/tmdb-hosts-override.ps1", "scripts"),
    ],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
