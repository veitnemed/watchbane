...
| Candidate pool operations | console via `candidates.service`; desktop planned | in progress |
...
- mark watched, retry KP, dedupe preview;
- TMDb build/import без дублирования console-логики.
