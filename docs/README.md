...
Документация активной версии: **Watchbane 0.1.0-alpha.1 — First Deck**, алгоритм рекомендаций **ReDeck v0.1 Alpha**. Если документ не помечен как historical/archive, он относится к этой версии. Канонический контракт: [../VERSION.md](../VERSION.md).
