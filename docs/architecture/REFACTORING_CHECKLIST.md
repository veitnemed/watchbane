...
- Не переносить ручные scripts в runtime. Если script стал обычным сценарием приложения, доменную логику вынести в активный слой, а script оставить CLI-обёрткой.
