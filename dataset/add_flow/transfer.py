...
def build_candidate_transfer_bundle(candidate: dict) -> AddTitleResolveBundle:
    ...
    description = meta_payload.get("description") or candidate.get("overview") or candidate.get("description")
